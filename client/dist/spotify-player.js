...
!(function e(t, n, r) {
...
})(
  {
    1: [
      ...
      { "./promise_resolver": 2, "./user_agent": 3, tslib: 6 },
    ],
    2: [
      function (e, t, n) {
        "use strict";
    ...
    3: [
      ...
      { "./interpolate_ua": 4, "./parse_ua": 5, tslib: 6 },
    ],
    4: [
      function (e, t, n) {
        "use strict";
    ...
    5: [
      function (e, t, n) {
        ...
        n.parseUA = function (e, t) {
          ...
          "trident" === d[1]
            ? ((d[1] = "ie"), d[4] && (d[2] = d[4]))
            : "crios" === d[1] && (d[1] = "chrome"),
            "win" ===
              (c = u.match(/ip(?:ad|od|hone)/)
                ? "ios"
                : null !==
                    (n = (u.match(/(?:webos|android)/) ||
                      u.match(/mac|win|linux|cros/) ||
                      [])[0]) && void 0 !== n
                ? n
                : "other") && (c = "windows");
          var E = "version" === d[1] ? d[3] : d[1],
            ...
            y = {
              name:
                null !== (a = null == E ? void 0 : E.toString()) && void 0 !== a
                  ? a
                  : "unknown",
              version:
                null !== (i = null == h ? void 0 : h.toString()) && void 0 !== i
                  ? i
                  : "unknown",
              platform: c,
            };
            ...
            !(function (n) {
              ...
              (n = function (e, n) {
                ...
                (d = function () {
                  ...
                  for (t = 0; t < n; t++)
                    for (
                      var s = arguments[t], a = 0, i = s.length;
                      a < i;
                      a++, o++
                    )
                      r[o] = s[a];
    ...
    11: [
      function (e, t, n) {
        ...
        function a() {
          ...
          if (
            ((window.Spotify = { Player: s.setupPlayerEnv(window) }),
      ...
      { "../enums/errors": 8, "../error/player_error": 10, "./player_api": 12 },
    ],
    12: [
      function (e, t, n) {
        "use strict";
        ...
        n.setupPlayerEnv = function (e, t) {
          ...
          _.listen(e, function (t) {
            t === s.Messages.LOADED && (_.stopListening(e), f.resolve());
          });
          var d = p(n);
          return (function () {
            function t(t) {
              ...
              (this._options = {
                ...
                (this.isLoaded = f.promise.then(function () {
                  _.listen(e, u._handleMessages),
                    u._sendMessage(l.messages.init(u._options));
                }));
            }
            return (
              ...
              (t.prototype._onGetToken = function (e, t) {
                ...
                if ("function" == typeof r)
                  new Promise(r).then(function (e) {
                    n._sendMessage(l.messages.token(e, t));
                  });
                else {
                  if (
              ...
              (t.prototype._handleMessages = function (e, t, n) {
                var r, o;
                null === (o = (r = this._messageHandlers)[e]) ||
                  void 0 === o ||
                  o.call(r, t, n);
              }),
              ...
              (t.prototype.connect = function () {
                ...
                return this.isLoaded.then(function () {
                  var t,
                    n = e._sendMessage(l.messages.connect());
                  return (
                    (e._connectionRequests[n] = o.createPromiseResolver()),
              ...
              (t.prototype.getCurrentState = function () {
                ...
                return this.isLoaded.then(function () {
                  var t,
                    n = e._sendMessage(l.messages.getCurrentState());
                  return (
                    (e._getCurrentStateRequests[n] = o.createPromiseResolver()),
              ...
              (t.prototype.getVolume = function () {
                ...
                return this.isLoaded.then(function () {
                  var t,
                    n = e._sendMessage(l.messages.getVolume());
                  return (
                    (e._getVolumeRequests[n] = o.createPromiseResolver()),
      ...
      {
        "../enums/anthemEvents": 7,
        "../enums/errors": 8,
        "../enums/messages": 9,
        "../error/player_error": 10,
        "../shared/message_dispatcher": 13,
        "../shared/messages_factory": 14,
        "@js-sdk/common": 1,
        tslib: 6,
      },
    ],
